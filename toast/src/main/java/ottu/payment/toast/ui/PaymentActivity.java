...
import ottu.payment.toast.adapter.PaymentMethodAdapter;
import ottu.payment.toast.adapter.SavedCardAdapter;
import ottu.payment.toast.databinding.ActivityPaymentBinding;
...
import ottu.payment.toast.model.SocketData.SocketRespo;
import ottu.payment.toast.model.fetchTxnDetail.Card;
import ottu.payment.toast.model.fetchTxnDetail.PaymentMethod;
import ottu.payment.toast.model.fetchTxnDetail.RespoFetchTxnDetail;
import ottu.payment.toast.model.submitCHD.Card_SubmitCHD;
import ottu.payment.toast.model.submitCHD.SubmitCHDToOttoPG;
import ottu.payment.toast.network.GetDataService;
import ottu.payment.toast.network.RetrofitClientInstance;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

import static ottu.payment.toast.network.RetrofitClientInstance.getRetrofitInstance;
import static ottu.payment.toast.network.RetrofitClientInstance.getRetrofitInstancePg;
import static ottu.payment.toast.util.Constant.Amount;
import static ottu.payment.toast.util.Constant.AmountCurrencyCode;
import static ottu.payment.toast.util.Constant.ApiId;
import static ottu.payment.toast.util.Constant.LocalLan;
import static ottu.payment.toast.util.Constant.MerchantId;
import static ottu.payment.toast.util.Constant.OttuPaymentResult;
import static ottu.payment.toast.util.Constant.SessionId;
import static ottu.payment.toast.util.Constant.SubmitUrlCard;
import static ottu.payment.toast.util.Constant.SubmitUrlRedirect;
import static ottu.payment.toast.util.Constant.savedCardSelected;
import static ottu.payment.toast.util.Constant.selectedCardPos;
import static ottu.payment.toast.util.Constant.selectedCardPosision;
import static ottu.payment.toast.util.Constant.sessionId;
import static ottu.payment.toast.util.Util.isDeviceRooted;
import static ottu.payment.toast.util.Util.isNetworkAvailable;
